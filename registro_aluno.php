								...
								<table class="table">
									<tbody>
										<tr>
											...
											<td><button><a href="update_tela.php?id=<?php echo $registro['id_dado']?>">Editar</a></button></td>
											<td><button><a href="delete.php?id=<?php echo $registro['id_dado'];?>">Excluir</a></button></td>
										</tr>
									</tbody>
								</table>
